...
const char* check(int item_num, char *ans);
...
void mainMenu2(char name1[],char name2[]) ////////////มาใส่ HOW TO PLAY
{
    char menu[20];
    system("cls");
	readFile("logo.txt");
...
int play(char name[])
{
    ...
    do{
        ...
        if( lose%3==0 && lose!=0 && strcmp(cont,"y")==0 )
            {
                ...
                printf("\n\nAnswer >> ");
                scanf("%s",&answ);
                strcpy(cont , check(lose/3,answ));
            }
        round++;
    }   while( (strcmp(cont,"y")==0 || strcmp(cont,"Y")==0)&& lose<=32 );
...
void play2(char name1[],char name2[])
{
    char P1[20],P2[20],COM[20],cont[2]="Y",WHOW;
...
const char* comHand2(char *P1,char *P2)
{
    ...
    if(strcmp(P1,P2)!=0)
    {
        ...
        if (ComHand == 1 )
        {
            ...
            if (strcmp(P1,"p") || strcmp(P1,"P"))
            {
                return "p";
            }
            if (strcmp(P1,"s") || strcmp(P1,"S"))
            {
                return "s";
            }
        }
        if (ComHand == 2)
        {
            ...
            if (strcmp(P2,"p") || strcmp(P2,"P"))
            {
                return "p";
            }
            if (strcmp(P2,"s") || strcmp(P2,"S"))
            {
                return "s";
            }
        }
